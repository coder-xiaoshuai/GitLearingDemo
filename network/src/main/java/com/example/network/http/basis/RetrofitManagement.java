package com.example.network.http.basis;

import com.example.network.BuildConfig;
import com.example.network.holder.ContextHolder;
import com.example.network.http.basis.config.HttpCode;
import com.example.network.http.basis.config.HttpConfig;
import com.example.network.http.basis.exception.AccountInvalidException;
import com.example.network.http.basis.exception.ServerResultException;
import com.example.network.http.basis.exception.TokenInvalidException;
import com.example.network.http.basis.interceptor.FilterInterceptor;
import com.example.network.http.basis.interceptor.HeaderInterceptor;
import com.example.network.http.basis.interceptor.HttpInterceptor;
import com.example.network.http.basis.model.BaseResponseBody;
...
public class RetrofitManagement {
    ...
    private Retrofit createRetrofit(String url) {
        OkHttpClient.Builder builder = new OkHttpClient.Builder().readTimeout(READ_TIMEOUT, TimeUnit.MILLISECONDS)
