...
import com.example.network.http.basis.callback.RequestCallback;
import com.example.network.http.basis.callback.RequestMultiplyCallback;
import com.example.network.http.basis.config.HttpCode;
import com.example.network.http.basis.exception.base.BaseException;
import com.example.network.viewmodel.base.BaseViewModel;
