...
public class DoubleFingerActivity extends AppCompatActivity {
    ...
    private PointF mid = new PointF();//两只中点
                ...
                case MotionEvent.ACTION_MOVE:
                    ...
                    if (mode == 2) {
                        ...
                        if (distance > 10f) {
                            ...
                            matrix.postScale(scale, scale, mid.x, mid.y);//缩放比例和缩放中心点坐标
                        }
                    }
                    break;
            }
